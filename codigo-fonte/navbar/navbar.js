...
function exibirNavbar() {
    ...
    if (usuarioLogado) {
        navDiv.innerHTML = `
        <figure id="logo">
            <a href="../home/index.html"><img class="logo" src="...." alt="logo" /></a>
        </figure>
        <div id="menu">
            <ul>
                <li><a href="../home/index.html">inicia</a></li>
        ...
        <div id="menu">
            <ul>
                ...
                <li><a href="../criar-curriculo/crie-seu-curriculo.html">CRIE</a></li>
                <li><a href="../suas-candidaturas/suas-candidaturas.html">ORGANIZE</a></li>
                <li><a href="../login-e-signup/login.html">CONECTE-SE</a></li>
                <li><a href="../login-e-signup/signup.html">INSCREVER-SE</a></li>
            </ul>
        </div>
        `;
    }
